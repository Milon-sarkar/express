            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form action="{{ route('login.merchant') }}" class="text-left" method="POST">
                            @csrf
                            @if ($errors->any())
                            ...
                            <div class="form">
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    ...
                                    <label style="margin-top: 30px;" for="">Dont Have A Account ?<a href="{{route('register.merchant')}}">Register Here</a></label>
